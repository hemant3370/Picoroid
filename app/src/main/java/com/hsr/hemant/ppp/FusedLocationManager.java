 ...
 */
public class FusedLocationManager extends AppCompatActivity implements
        ConnectionCallbacks,
    ...
    public void onLocationChanged(Location location) {
        ...
        mLastUpdateTime = DateFormat.getTimeInstance().format(new Date());
        updateLocationUI();
        Toast.makeText(this, getResources().getString(R.string.cast_notification_connected_message),
