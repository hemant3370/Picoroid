 ...
 * profile.
 */
public class gSignIn extends AppCompatActivity implements
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (isFirstStart) {
                    ...
                    //  Launch app intro
                    Intent i = new Intent(gSignIn.this, MyAppIntro.class);
                    startActivity(i);
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            MyApplication.getInstance().setUserPhotoUri(acct.getPhotoUrl());
