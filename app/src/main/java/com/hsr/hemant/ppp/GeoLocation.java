...
public class GeoLocation {
    ...
    public double radLat;  // latitude in radians
    public double radLon;  // longitude in radians
    public double degLat;  // latitude in degrees
    public double degLon;  // longitude in degrees
